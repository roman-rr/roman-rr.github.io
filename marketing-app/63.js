...
var Route = function () { function t() { this.url = ""; } return t.prototype.onUpdate = function (t) { this.ionRouteDataChanged.emit(t); }, t.prototype.onComponentProps = function (t, e) { if (t !== e) {
...
function writeNavState(t, e, n, r, o) { return void 0 === o && (o = !1), _polyfills_tslib_js__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () { var i, a, s, u; return _polyfills_tslib_js__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (c) { switch (c.label) {
    case 0: return c.trys.push([0, 6, , 7]), i = searchNavNode(t), r >= e.length || !i ? [2, o] : [4, i.componentOnReady()];
    case 1: return c.sent(), [4, i.setRouteId((a = e[r]).id, a.params, n)];
    case 2: return (s = c.sent()).changed && (n = ROUTER_INTENT_NONE, o = !0), [4, writeNavState(s.element, e, n, r + 1, o)];
    case 3: return o = c.sent(), s.markVisible ? [4, s.markVisible()] : [3, 5];
    case 4: c.sent(), c.label = 5;
    case 5: return [2, o];
    case 6: return u = c.sent(), console.error(u), [2, !1];
    case 7: return [2];
} }); }); }
function readNavState(t) { return _polyfills_tslib_js__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () { var e, n, r, o; return _polyfills_tslib_js__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (i) { switch (i.label) {
...
function flattenNode(t, e, n) { var r = t.slice(); if (r.push({ id: n.id, path: n.path, params: n.params }), 0 !== n.children.length)
    ...
    e.push(r); }
var Router = function () { function t() { this.previousPath = null, this.busy = !1, this.state = 0, this.lastState = 0, this.root = "/", this.useHash = !0; } return t.prototype.componentWillLoad = function () { return _polyfills_tslib_js__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () { return _polyfills_tslib_js__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (t) { switch (t.label) {
    ...
    case 2: return [2, e];
} }); }); }, t.prototype.writeNavState = function (t, e, n, r, o, i) { return void 0 === i && (i = 0), _polyfills_tslib_js__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () { var a, s; return _polyfills_tslib_js__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (u) { switch (u.label) {
...
} }); }); }, t.prototype.componentDidUnload = function () { this.activeEl = this.activeComponent = void 0, this.gesture && (this.gesture.destroy(), this.gesture = void 0); }, t.prototype.commit = function (t, e, n) { return _polyfills_tslib_js__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () { var r, o, i; return _polyfills_tslib_js__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (a) { switch (a.label) {
    case 0: return [4, this.lock()];
    ...
    case 5: return r(), [2, o];
} }); }); }, t.prototype.setRouteId = function (t, e, n) { return _polyfills_tslib_js__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () { return _polyfills_tslib_js__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (r) { switch (r.label) {
