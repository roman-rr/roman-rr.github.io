...
var Icon = function () { function t() { this.isVisible = !1, this.lazy = !1; } return t.prototype.componentWillLoad = function () { var t = this; this.waitUntilVisible(this.el, "50px", function () { t.isVisible = !0, t.loadIcon(); }); }, t.prototype.componentDidUnload = function () { this.io && (this.io.disconnect(), this.io = void 0); }, t.prototype.waitUntilVisible = function (t, e, n) { var o = this; if (this.lazy && this.win && this.win.IntersectionObserver) {
    var i = this.io = new this.win.IntersectionObserver(function (t) { t[0].isIntersecting && (i.disconnect(), o.io = void 0, n()); }, { rootMargin: e });
    i.observe(t);
}
else
    n(); }, t.prototype.loadIcon = function () { var t = this; if (!this.isServer && this.isVisible) {
    var e = this.getUrl();
    e ? getSvgContent(this.doc, e, "s-ion-icon").then(function (e) { return t.svgContent = e; }) : console.error("icon was not resolved");
} if (!this.ariaLabel) {
    var n = getName(this.getName(), this.mode, this.ios, this.md);
    n && (this.ariaLabel = n.replace("ios-", "").replace("md-", "").replace(/\-/g, " "));
...
function getSvgContent(t, e, n) { var o = requests.get(e); return o || (o = fetch(e, { cache: "force-cache" }).then(function (t) { return isStatusValid(t.status) ? t.text() : Promise.resolve(null); }).then(function (e) { return validateContent(t, e, n); }), requests.set(e, o)), o; }
function isStatusValid(t) { return t <= 299; }
function validateContent(t, e, n) { if (e) {
    var o = t.createDocumentFragment(), i = t.createElement("div");
    i.innerHTML = e, o.appendChild(i);
    for (var r = i.childNodes.length - 1; r >= 0; r--)
        "svg" !== i.childNodes[r].nodeName.toLowerCase() && i.removeChild(i.childNodes[r]);
    var s = i.firstElementChild;
    if (s && "svg" === s.nodeName.toLowerCase() && (n && s.setAttribute("class", n), isValid(s)))
        return i.innerHTML;
} return ""; }
function createColorClasses$1(t) { var e; return t ? ((e = { "ion-color": !0 })["ion-color-" + t] = !0, e) : null; }
