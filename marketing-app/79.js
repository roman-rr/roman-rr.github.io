...
var SPLIT_PANE_MAIN = "split-pane-main", SPLIT_PANE_SIDE = "split-pane-side", QUERY = { xs: "(min-width: 0px)", sm: "(min-width: 576px)", md: "(min-width: 768px)", lg: "(min-width: 992px)", xl: "(min-width: 1200px)", never: "" }, SplitPane = function () { function e() { this.visible = !1, this.disabled = !1, this.when = QUERY.lg; } return e.prototype.visibleChanged = function (e) { var t = { visible: e, isPane: this.isPane.bind(this) }; this.ionSplitPaneVisible.emit(t); }, e.prototype.componentDidLoad = function () { this.styleChildren(), this.updateState(); }, e.prototype.componentDidUnload = function () { this.rmL && (this.rmL(), this.rmL = void 0); }, e.prototype.updateState = function () { var e = this; if (!this.isServer)
        ...
        if ("boolean" != typeof t) {
            ...
            if (0 !== i.length) {
                if (this.win.matchMedia) {
                    var n = function (t) { e.visible = t.matches; }, s = this.win.matchMedia(i);
                    s.addListener(n), this.rmL = function () { return s.removeListener(n); }, this.visible = s.matches;
                }
            }
            else
                this.visible = !1;
    ...
    for (var e = this.contentId, t = this.el.children, i = this.el.childElementCount, n = !1, s = 0; s < i; s++) {
        var a = t[s], r = void 0 !== e ? a.id === e : a.hasAttribute("main");
        if (r) {
            if (n)
    ...
    n || console.warn("split pane does not have a specified main node");
...
function setPaneClass(e, t) { var i, n; t ? (i = SPLIT_PANE_MAIN, n = SPLIT_PANE_SIDE) : (i = SPLIT_PANE_SIDE, n = SPLIT_PANE_MAIN); var s = e.classList; s.add(i), s.remove(n); }
