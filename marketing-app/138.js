...
function iosEnterAnimation(t, e, o) { var n = new t, i = new t, s = e.host || e, r = e.querySelector(".toast-wrapper"); switch (i.addElement(r), o) {
    case "top":
        i.fromTo("translateY", "-100%", "calc(10px + var(--ion-safe-area-top, 0px))");
        break;
    case "middle":
        var a = Math.floor(s.clientHeight / 2 - r.clientHeight / 2);
        r.style.top = a + "px", i.fromTo("opacity", .01, 1);
        break;
    default: i.fromTo("translateY", "100%", "calc(-10px - var(--ion-safe-area-bottom, 0px))");
} return Promise.resolve(n.addElement(s).easing("cubic-bezier(.155,1.105,.295,1.12)").duration(400).add(i)); }
function iosLeaveAnimation(t, e, o) { var n = new t, i = new t, s = e.host || e, r = e.querySelector(".toast-wrapper"); switch (i.addElement(r), o) {
    case "top":
        i.fromTo("translateY", "calc(10px + var(--ion-safe-area-top, 0px))", "-100%");
        break;
    case "middle":
        i.fromTo("opacity", .99, 0);
        break;
    default: i.fromTo("translateY", "calc(-10px - var(--ion-safe-area-bottom, 0px))", "100%");
} return Promise.resolve(n.addElement(s).easing("cubic-bezier(.36,.66,.04,1)").duration(300).add(i)); }
function mdEnterAnimation(t, e, o) { var n = new t, i = new t, s = e.host || e, r = e.querySelector(".toast-wrapper"); switch (i.addElement(r), o) {
    case "top":
        r.style.top = "calc(8px + var(--ion-safe-area-top, 0px))", i.fromTo("opacity", .01, 1);
        break;
    case "middle":
        var a = Math.floor(s.clientHeight / 2 - r.clientHeight / 2);
        r.style.top = a + "px", i.fromTo("opacity", .01, 1);
        break;
    default: r.style.bottom = "calc(8px + var(--ion-safe-area-bottom, 0px))", i.fromTo("opacity", .01, 1);
} return Promise.resolve(n.addElement(s).easing("cubic-bezier(.36,.66,.04,1)").duration(400).add(i)); }
function mdLeaveAnimation(t, e) { var o = new t, n = new t, i = e.host || e, s = e.querySelector(".toast-wrapper"); return n.addElement(s), n.fromTo("opacity", .99, 0), Promise.resolve(o.addElement(i).easing("cubic-bezier(.36,.66,.04,1)").duration(300).add(n)); }
