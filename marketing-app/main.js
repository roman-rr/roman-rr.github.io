...
/* harmony import */ var _picker_picker_page__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./picker/picker.page */ "./src/app/picker/picker.page.ts");
...
var routes = [
    { path: '', redirectTo: '', pathMatch: 'full', component: _home_home_page__WEBPACK_IMPORTED_MODULE_8__["HomePage"] },
    { path: 'picker', component: _picker_picker_page__WEBPACK_IMPORTED_MODULE_9__["PickerPage"] }
];
var AppModule = /** @class */ (function () {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [_app_component__WEBPACK_IMPORTED_MODULE_7__["AppComponent"], _home_home_page__WEBPACK_IMPORTED_MODULE_8__["HomePage"], _picker_picker_page__WEBPACK_IMPORTED_MODULE_9__["PickerPage"]],
            entryComponents: [],
            imports: [
...
module.exports = "<ion-content scrollY=\"false\">\n  <div class=\"bg-image\" [ngStyle]=\"{'background-image' : 'url(assets/img/8.jpg)', \n                                    'background-position-y' : '-30px' }\">\n  </div>\n  <div class=\"bg-mask\" [ngStyle]=\"{'background' : 'linear-gradient(rgba(125, 185, 232, 0) 0%, rgb(59, 66, 115) 20%, rgb(35, 43, 64) 100%)'}\">\n  </div>\n  <div class=\"content\">\n    <!-- Offer -->\n    <h1 style=\"color:#ffffff;\">капитанский Комплект</h1>\n    <!-- Description -->\n    <p style=\"color:#ffffff;\">\n      Родители обезумели от этого вязаного комплекта для малыша! 5 предметов в комплекте!\n    </p>\n    <!-- Action -->\n    <ion-button color=\"light\" expand=\"block\" (click)=\"goNext();\">Продолжить</ion-button>\n  </div>\n</ion-content>"
...
var HomePage = /** @class */ (function () {
    function HomePage(activatedRoute, nav) {
        var _this = this;
    ...
    HomePage.prototype.goNext = function () {
        ...
        this.nav.navigateForward(['picker'], navigationExtras);
    };
...
/***/ "./src/app/picker/picker.page.html":
/*!*****************************************!*\
  !*** ./src/app/picker/picker.page.html ***!
  \*****************************************/
/*! no static exports found */
...
module.exports = "<ion-header>\n    <ion-toolbar>\n      <ion-title>КАПИТАНСКИЙ КОМПЛЕКТ</ion-title>\n      <ion-buttons slot=\"start\">\n        <ion-back-button text=\"\" icon=\"back-custom\"></ion-back-button>\n      </ion-buttons>\n    </ion-toolbar>\n</ion-header>\n\n<ion-content scrollY=\"false\">\n  <div class=\"content\">\n    <!-- Offer -->\n    <h1>{{id}}</h1>\n  </div>\n</ion-content>"

/***/ }),

/***/ "./src/app/picker/picker.page.scss":
/*!*****************************************!*\
  !*** ./src/app/picker/picker.page.scss ***!
  \*****************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3BpY2tlci9waWNrZXIucGFnZS5zY3NzIn0= */"

/***/ }),

/***/ "./src/app/picker/picker.page.ts":
/*!***************************************!*\
  !*** ./src/app/picker/picker.page.ts ***!
  \***************************************/
...
var PickerPage = /** @class */ (function () {
    function PickerPage(activatedRoute) {
        var _this = this;
        this.activatedRoute = activatedRoute;
        this.activatedRoute.queryParams.subscribe(function (params) {
            _this.id = params['id'];
    ...
    PickerPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-picker',
            template: __webpack_require__(/*! ./picker.page.html */ "./src/app/picker/picker.page.html"),
            styles: [__webpack_require__(/*! ./picker.page.scss */ "./src/app/picker/picker.page.scss")]
        }),
