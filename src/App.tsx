  ...
  return (
    <div className="min-h-screen bg-[#f9f9f9] flex flex-col">
      <div className="flex-grow">
          ...
          <div className="flex flex-col items-center mb-10 mt-10">
            <div className="flex flex-col gap-3 mb-2">
              ...
              <h2 className="text-xl text-center text-gray-600 max-w-2xl">
                20+ years full-stack expertise, $400k earned on Upwork in Laravel, TypeScript, LangChain, Python & OpenAI API.
              </h2>
        ...
        {/* Cases Section */}
        <div className="px-[30px] mt-8 mb-14">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-xl font-bold mb-6 text-[#333]">
              Recent Cases
            </h2>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <a
                href="/docs/pt-agents/pt-agents-architecture.html"
                target="_blank"
                rel="noopener noreferrer"
                className="bg-[#f5f5f5] rounded-lg overflow-hidden border border-[#e0e0e0]"
              >
                <div className="h-[140px] overflow-hidden border-b border-[#e0e0e0]">
                  <img src="/docs/pt-agents/web-ui-chatbot-1.png" alt="PT Agents UI" className="w-full h-full object-cover object-top" />
                </div>
                <div className="p-4">
              ...
              <a
                href="/docs/pt-calls/pt-calls-pipeline-arch.html"
                target="_blank"
                rel="noopener noreferrer"
                className="bg-[#f5f5f5] rounded-lg overflow-hidden border border-[#e0e0e0]"
              >
                <div className="h-[140px] overflow-hidden border-b border-[#e0e0e0]">
                  <img src="/docs/pt-calls/4com-dashboard-1.png" alt="PT Calls Dashboard" className="w-full h-full object-cover object-top" />
                </div>
                <div className="p-4">
                  <div className="flex items-center justify-between mb-2">
              ...
              <a
                href="/docs/pt-emails/pt-emails-pipeline-arch.html"
                target="_blank"
                rel="noopener noreferrer"
                className="bg-[#f5f5f5] rounded-lg overflow-hidden border border-[#e0e0e0]"
              >
                <div className="h-[140px] overflow-hidden border-b border-[#e0e0e0]">
                  <img src="/docs/pt-emails/pt-emails-dashboard-1.png" alt="PT Emails Dashboard" className="w-full h-full object-cover object-top" />
                </div>
                <div className="p-4">
                  <div className="flex items-center justify-between mb-2">
